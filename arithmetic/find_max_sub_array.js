...
// 最大连续子数组如果包括第一个元素，则用第一个元素和后面的 arr.length - 1 个元素做分别组成数组，然后做比较，记录 下 maxSum 和 begin, end
// 一轮循环下来，得到了包含第一个元素的所有连续子数组 中 的那个最大连续子数组，接下来，计算 数组第一个元素是 原数组第二个元素 的子数组....
